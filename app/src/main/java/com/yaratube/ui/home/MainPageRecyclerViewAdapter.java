...
import com.yaratube.data.model.Headeritem;
import com.yaratube.data.model.Homeitem;
...
public class MainPageRecyclerViewAdapter extends RecyclerView.Adapter<MainPageRecyclerViewAdapter.ViewHolder> {
    ...
    public void setData(MainPage mainPage){
        headeritems = mainPage.getHeaderitem();
        homeitems = mainPage.getHomeitem();
